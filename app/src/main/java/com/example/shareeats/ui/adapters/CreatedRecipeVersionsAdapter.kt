...
import com.example.shareeats.ui.CreatedRecipeVersionsActivity
...
class CreatedRecipeVersionsAdapter(private val context: CreatedRecipeVersionsActivity, private var recipeList: ArrayList<Recipe> )
    : RecyclerView.Adapter<CreatedRecipeVersionsAdapter.ViewHolder>() {
        ...
        fun bind(recipe: Recipe, position: Int) {
            ...
            val objectListener = object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.tvCreatedBy.text = "Version by : @${userInfo?.name}"
